...
{{ include "signavio.app.deploy.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "signavio.app.deploy.selectorLabels" -}}
...
Selector labels
*/}}
{{- define "signavio.bdm.deploy.selectorLabels" -}}
app.kubernetes.io/name: {{ include "deploy.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
app: bdm
tier: backend
...
Selector labels
*/}}
{{- define "signavio.solr.deploy.selectorLabels" -}}
app.kubernetes.io/name: {{ include "deploy.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
app: solr
tier: backend
...
{{- define "helpers.list-signavio-env-variables"}}
